...
const { colors, spacing, typography } = dragonChampionshipsLightTheme;

interface MapScreenLocalProps {
  onBack?: () => void;
}

export const MapScreen: React.FC<Partial<MapScreenProps> & MapScreenLocalProps> = ({ navigation, onBack }) => {
